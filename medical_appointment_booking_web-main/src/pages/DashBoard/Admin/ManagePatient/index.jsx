...
const ManagePatient = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_, { image }) => {
        return (
          image ? <img src={"https://medical-appointment-booking-api-production.up.railway.app/images/patients/" + image} alt="" style={{ width: '50px', height: '50px', borderRadius: '50%', objectFit: 'cover' }} /> : null);
      },
